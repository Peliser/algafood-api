...
public interface RestauranteProdutoFotoControllerOpenApi {
    ...
    FotoProdutoModel upload(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long restauranteId,
    ...
    ResponseEntity<?> download(Long restauranteId, Long produtoId, String acceptHeader)
