...
insert into permissao (id, nome, descricao) values (5, 'CONSULTAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite consultar usuários e grupos de permissões');
insert into permissao (id, nome, descricao) values (6, 'EDITAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite criar ou editar usuários e grupos de permissões');
...
(1, 'Diego Peliser', 'peliser.diego@gmail.com', '$2y$12$NSsM4gEOR7MKogflKR7GMeYugkttjNhAJMvFdHrBLaLp2HzlggP5W', utc_timestamp),
...
values (
  'algafood-web', null, '$2y$12$e1hZxTQNBIpkwXNwKnL9ZuGpFptNb/FOQt1PrDzFGtIpuGU2rnwCi',
...
values (
  'foodanalytics', null, '$2y$12$e1hZxTQNBIpkwXNwKnL9ZuGpFptNb/FOQt1PrDzFGtIpuGU2rnwCi',
...
values (
  'faturamento', null, '$2y$12$e1hZxTQNBIpkwXNwKnL9ZuGpFptNb/FOQt1PrDzFGtIpuGU2rnwCi',
